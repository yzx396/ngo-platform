  ...
  useTranslation: () => ({
    t: (key: string, defaultValue?: string | Record<string, unknown>) => {
      const translations: Record<string, string> = {
        ...
        'points.commonRules.likeReceivedPoints': '2 points',
        'points.rulesDialog.commentReceived': 'Comment on your post',
        'points.commonRules.commentReceivedPoints': '3 points',
        ...
        'points.commonRules.antiSpamDesc': 'To maintain quality and prevent spam, we use a diminishing returns system.',
        'points.commonRules.likesPerHour': 'Likes per hour',
        'points.commonRules.first5Likes': 'First 5 likes: 2 points each',
        'points.commonRules.next10Likes': 'Next 10 likes: 1 point each (50%)',
        'points.commonRules.beyond15Likes': 'Beyond 15 likes: 0 points',
        'points.commonRules.commentsPerHour': 'Comments per hour',
        'points.commonRules.first10Comments': 'First 10 comments: 5 points each',
        'points.commonRules.next10Comments': 'Next 10 comments: 2 points each (40%)',
        'points.commonRules.beyond20Comments': 'Beyond 20 comments: 0 points',
